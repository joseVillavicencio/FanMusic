		...
		<div class="panel panel-body"><div class="input-group"></div>
			<div class="input-group"><span class="input-group-addon" id="basic-addon3">T&iacute;tulo</span>
				...
				<script type="text/javascript">
					$('#tituloNuevo').tooltip({'trigger':'focus', 'title': 'Debes ingresar el nombre de la canción(máx 50 caracteres)'});
				</script>
			</div><br>
			<div class="input-group"><span class="input-group-addon" id="basic-addon3">Álbum</span>
				...
				<script type="text/javascript">
					$('#albumNuevo').tooltip({'trigger':'focus', 'title': 'Debes ingresar el álbum al que pertenece la canción(máx 50 carateres)'});
				</script>
			</div><br>
