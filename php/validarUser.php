		...
		if($result = $conexion->query($verificacion)){
			if($result->num_rows >0){
				...
				if($result2 = $conexion->query($sql)){
					...
					header('Location: http://158.251.194.16:80/FanMusic/indexNuevo.php');
				}
			}else{
				...
				echo "<div class='panel' style='text-align:center;'>Tu cuenta se encuentra activada<br><a href='http://158.251.194.16:80/FanMusic/indexNuevo.php'>Continuar</a></div>";
			}	
		}else{
