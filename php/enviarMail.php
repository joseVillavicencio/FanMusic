...
$body = "Hola ".$nombre.", Bienvenido a FanMusic y para activar tu cuenta necesitas ingresar en la siguiente url: http://localhost/FanMusic/php/validarUser.php?email=".$correo."&key=".$cod;   
